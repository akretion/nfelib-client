...
from nfelib_client.nfe.soap.v4_0.nfeautorizacao4 import (
    NfeAutorizacao4SoapNfeAutorizacaoLote,
)
from nfelib_client.nfe.soap.v4_0.nfeconsulta4 import (
    NfeConsultaProtocolo4SoapNfeConsultaNf,
)

# TODO distribuição:
from nfelib_client.nfe.soap.v4_0.nfedistribuicaodfe import (
    NfeDistribuicaoDfeSoapNfeDistDfeInteresse,
)
from nfelib_client.nfe.soap.v4_0.nfeinutilizacao4 import (
    NfeInutilizacao4SoapNfeInutilizacaoNf,
)
from nfelib_client.nfe.soap.v4_0.nferetautorizacao4 import (
    NfeRetAutorizacao4SoapNfeRetAutorizacaoLote,
)
from nfelib_client.nfe.soap.v4_0.nfestatusservico4 import (
    NfeStatusServico4SoapNfeStatusServicoNf,
)
from nfelib_client.nfe.soap.v4_0.recepcaoevento4 import (
